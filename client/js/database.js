...
{"restaurant_name": "East_Meets_West", "meal_time": ["breakfast", "lunch", "dinner"], "food_category": ["asian"], "price": "min", "goal_meal": [""]};
...
{"restaurant_name": "Porcellino_Bistro", "meal_time": ["lunch", "dinner"], "food_category": ["italian", "american"], "price": "med", "goal_meal": ["pizza", "salad", "sandwiche", "panini"]};
{"restaurant_name": "Sy", "meal_time": ["lunch", "dinner"], "food_category": ["italian"], "price": "min", "goal_meal": ["pizza"]};
{"restaurant_name": "Taylors", "meal_time": ["breakfast", "lunch", "dinner"], "food_category": ["pubfood", "american"], "price": "min", "goal_meal": ["egg", "sandwiche", "chicken", "gardenburger", "steak", "nacho", "hotwing" "pancake", "salad", "quesadilla", "burger", "gyro", "falafel", "burrito"]};
